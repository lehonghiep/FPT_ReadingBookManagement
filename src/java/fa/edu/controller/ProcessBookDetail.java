...
import fa.edu.service.BookCaseService;
 ...
 * @author Hong Hiep IT
 */
public class ProcessBookDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isAdded=BookCaseService.checkExistInBookCase(user.getId(), Integer.valueOf(bookID));
        
        BookVO bookVO=BookService.getBookVOById(bookID);
        request.setAttribute("bookVO", bookVO);
        request.setAttribute("isAdded", isAdded);
        RequestDispatcher dis=request.getRequestDispatcher("WEB-INF/bookDetail.jsp");
