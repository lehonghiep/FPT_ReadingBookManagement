            ...
            <div class="sidebar" data-color="purple" data-background-color="white" data-image="${pageContext.request.contextPath}/assets/img/sidebar-1.jpg">
                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="ProcessBookList">
                                <i class="material-icons">list_alt</i>
                                <p>Book List</p>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="ProcessCreateBookPage">
                                <i class="material-icons">library_books</i>
                                <p>Create Book</p>
                            </a>
                        </li>
                        <li class="nav-item active ">
                            <a class="nav-link" href="ProcessCreateAuthorPage">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="ProcessToCreatePublisherPage">
                                <i class="material-icons">business</i>
                                <p>Create Publisher</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="ProcessToCreateCategoryPage">
                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#">CREATE AUTHOR</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="ProcessCreateAuthor" method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="container">
                                                    <label class="bmd-label-floating">Birth Date</label><br/>
                                                    <input name="birth-date" type="date" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="container">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" name="phone" id="phone" maxlength="10" pattern="[0-9]{3}[0-9]{3}[0-9]{4}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button type="submit" class="btn btn-primary pull-right">CREATE AUTHOR</button> 
                            ...
                            <div class="col-md-6">
                                <div class="card card-profile">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-category text-gray"><b>SHERLOCK HOLMES</b></h3> <!--Tên TÁC GIẢ-->
                                        <h4 class="card-title">Gender: </h4> <!--Tác giả-->
                                        <h4 class="card-title">Birth Date: </h4> 
                                        <h4 class="card-title">Email: </h4> 
                                        <h4 class="card-title">Phone: </h4> 
                                        <p class="card-description" style="font-size: 17px"> <!--BRIEF-->
