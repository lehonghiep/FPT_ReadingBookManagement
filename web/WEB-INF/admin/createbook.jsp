...
<html lang="en">
    ...
    <body class="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="form" action="ProcessCreateNewBook" method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="author" class="form-control" id="exampleFormControlSelect1">
                                                            <c:forEach var="author" items="${listAuthorVO}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="publisher" class="form-control" id="exampleFormControlSelect1">
                                            ...
                                            <input id="imageCover" type="hidden" name="imageCover"/>
                                        </form>
                            ...
                            <div class="col-md-6">
                                <div class="card card-profile">
                                    ...
                                    <form action="" method="POST" role="form">
                                        <input id="file" type="file" class="file-upload" required=""/>
                                    </form>
                                    <br>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/createbook.js"></script>
