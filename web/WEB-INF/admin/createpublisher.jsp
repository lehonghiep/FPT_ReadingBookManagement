                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#">CREATE PUBLISHER</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="ProcessCreatePublisher" method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="phone" type="tel" class="form-control" name="phone" id="phone" maxlength="10" pattern="[0-9]{3}[0-9]{3}[0-9]{4}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <button type="submit" class="btn btn-primary pull-right">CREATE PUBLISHER</button> 
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title"> Publisher's Created</h4>
                                        <!-- <p class="card-category">Complete your profile</p> -->
                                    </div>

                                    <div class="card-body">
                                        <form>
                                            <h3 class="card-category text-gray">Name: </h3> <br>
                                            <h3 class="card-category text-gray">Phone: </h3> <br>
                                            <h3 class="card-category text-gray">Email: </h3> 
                                            <div class="clearfix"></div>
                                        </form>
                                    </div>
                                </div>
